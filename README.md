A wrapper around the [case-repository API]((https://github.com/SKAshwin/case-repository)) currently hosted at lcsscaseapi.duckdns.org (if this changes you need to chang the domain name in constants.py).
